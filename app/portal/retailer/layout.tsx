...
export default function RetailerPortalLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col">
      <header className="bg-stone-900 text-white px-4 lg:px-6 py-3 flex items-center justify-between shrink-0">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-stone-800/20 border border-stone-800/30 flex items-center justify-center">
