...
import { supabase, AttributeField } from '@/lib/supabase'
  ...
  function updateField(index: number, updates: Partial<AttributeField>) {
    setFields(prev =>
      prev.map((f, i) => {
        ...
        // If label changes and key is empty or looks like a slug of the old label, update key
    ...
    <div className="p-4 lg:p-7 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <h1 className="text-xl font-semibold text-stone-900 tracking-tight">Create Category</h1>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="sm:col-span-2">
              ...
              <p className="text-[10px] text-stone-400 mt-1">
                Generated Slug: <span className="font-mono">{slugify(name) || '(waiting for name)'}</span>
              </p>
            </div>
            <div>
