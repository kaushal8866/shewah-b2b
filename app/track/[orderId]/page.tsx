      ...
      <div className="bg-stone-900 border-b border-stone-800">
        <div className="max-w-lg mx-auto px-4 py-5">
          <div className="flex items-center gap-3 mb-1">
            <div className="w-8 h-8 rounded-xl bg-stone-800 flex items-center justify-center shrink-0">
              ...
              return (
                <div key={stage.value} className="flex items-stretch gap-4">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    {!isLast && (
                      <div className={`w-0.5 flex-1 min-h-5 mt-1 mb-1 transition-colors ${isDone ? 'bg-stone-300/60' : 'bg-stone-800'}`} />
                    )}
                  </div>
                  {/* Label column */}
                  <div className={`${isLast ? 'pb-0' : 'pb-4'} pt-1 flex-1`}>
                    <p className={`text-sm font-medium ${
                      isActive ? 'text-stone-300' : isDone ? 'text-stone-400' : 'text-stone-600'
                    }`}>
                      {stage.label}
                      {isActive && (
