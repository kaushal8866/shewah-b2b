        ...
        <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
          ...
          <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col z-10">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
              {/* Core Details Card */}
              <div className="bg-[#F8FAFC] border border-stone-200 rounded-xl p-4 space-y-3">
                ...
                <div className="flex justify-between items-center border-t border-stone-100 pt-2">
                  ...
                  <span className="text-sm font-bold text-[#1E3A5F]">₹{Number(selectedTrade.total_amount).toLocaleString('en-IN')}</span>
                </div>
                    ...
                    <div className="bg-stone-50 border border-stone-200 rounded-xl p-4 space-y-3">
                      ...
                      <div className="flex justify-end gap-2 pt-1">
                        ...
                        <button onClick={handleAddPayment} disabled={savingPayment}
                          className="px-3 py-1.5 text-xs bg-[#1E3A5F] text-white rounded-lg hover:bg-[#162B47] disabled:opacity-50 font-medium">
