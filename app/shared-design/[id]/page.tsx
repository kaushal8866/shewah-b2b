    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <header className="bg-stone-900 px-5 py-4 flex items-center justify-between">
        ...
        <a href={buildWhatsAppLink()} target="_blank" rel="noreferrer"
          className="flex items-center gap-2 bg-[#25D366] text-white px-4 py-2 text-sm font-medium hover:bg-[#1ebe57] transition-colors">
      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="text-center mb-4">
          <span className="text-xs text-stone-900 bg-stone-50 px-3 py-1 font-medium">
            {product.code}
          </span>
        </div>
