...
// Task 102 — A/B test variant `original`.
// This is the landing page that shipped in task #85, preserved verbatim so
// we can split traffic against the Outcome-First redesign at LandingPage.tsx.
// Once the test concludes (see lib/landingVariant.ts kill-switch), the loser
// can be deleted in a follow-up cleanup. Until then, do not refactor either
// file — the whole point is to compare the two designs as-shipped.
...
export default function LandingPageOriginal({ whatsappE164 }: { whatsappE164?: string }) {
